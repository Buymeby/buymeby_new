...
import styles from './Styles/QuantitySelectorStyles'
...
export default class QuantitySelector extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = { quantity: props.value || props.minQuantity }
    ...
    return (
      <View style={[ styles.container, this.props.style ]}>
        ...
        <TextInput
          ...
          style={[ styles.quantityInput, { color: this.props.textColor }]}
          editable={ false }
